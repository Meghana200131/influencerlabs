    ...
    $(document).ready(function() {
        ...
        if ($('#wp-chatbot-shortcode-template-container').length == 0 && $('#wp-chatbot-chat-app-shortcode-container').length == 0) {
            ...
            if (wpChatBotVar.enable_ret_user_show == 1 && localStorage.getItem("wpwHitory") && $.cookie('return_user') != 'yes') {
                ...
                var data = {
                    'action': 'qcld_wb_chatbot_only_cart'
                };
            ...
            function wpwbot_board_action() {
                if (widowW <= 1024 && wpChatBotVar.mobile_full_screen == 1) { //For mobile
                    ...
                    $('.wp-chatbot-ball-inner').slimScroll({
                        ...
                        'top': $('.wp-chatbot-ball-inner').height() + 'px'
                    });
                    $('#wp-chatbot-chat-container').css({
                        'bottom': '0',
                        'left': '0',
                    ...
                    //alert(footerH);
                    $('.wp-chatbot-ball-inner').css({
                        'height': AppContentInner + 'px'
                    })
                    $(this).hide();
                } else {
                ...
                if (LoadwpwBotPlugin == 0) {
                    $.wpwbot({
                        obj: wpChatBotVar,
                        editor_handler: textEditorHandler,
                        preLoadingTime: wpChatBotVar.botpreloadingtime
                    });
                    LoadwpwBotPlugin++;
                    var data = {
                        'action': 'qcld_wb_chatbot_session_count'
                    };
                    jQuery.post(wpChatBotVar.ajax_url, data, function(response) {
                        //
                    });
            ...
            function showing_proactive_msg(msg) {
                ...
                $('.wp-chatbot-ball-inner').animate({
                    scrollTop: $('.wp-chatbot-messages-wrapper').prop("scrollHeight")
                }, 'slow').parent().find('.slimScrollBar').css({
                    'top': $('.wp-chatbot-ball-inner').height() + 'px'
                });
                setTimeout(function() {
                    $('#wp-chatbot-messages-container li:last .wp-chatbot-paragraph').html(msg).css({
                        'background-color': wpChatBotVar.proactive_bg_color
                    });
                    //scroll to the last message
                    $('.wp-chatbot-ball-inner').animate({
                        scrollTop: $('.wp-chatbot-messages-wrapper').prop("scrollHeight")
            ...
            function showing_proactive_double_msg(secondMsg) {
                ...
                setTimeout(function() {
                    ...
                    setTimeout(function() {
                        $('#wp-chatbot-messages-container li:last .wp-chatbot-paragraph').html(secondMsg).css({
                            'background-color': wpChatBotVar.proactive_bg_color
                        });
                        //Scroll to the last message
                        $('.wp-chatbot-ball-inner').animate({
                ...
                if (sessionStorage.getItem('wpChatbotNotification') && sessionStorage.getItem('wpChatbotNotification') == 'removed') {
                    ...
                    if (notifications.length > 1) {
                        ...
                        var notificationInterval = setInterval(function(e) {
                            ...
                            $('.wp-chatbot-notification-message').css({
                                'opacity': 1
                            }).html(notifications[notMsgIndex]);
                        }, intervalTime);
                    }
            ...
            if ($('.chatbot-shortcode-template-02').length == 0) {
                ...
                $('.wp-chatbot-widget .wp-chatbot-products').slimScroll({
                    height: '435px',
                    start: 'top'
                });
            }
            ...
            setTimeout(function() {
                ...
                //alert(footerH);
                $('#wp-chatbot-chat-app-shortcode-container .wp-chatbot-ball-inner').css({
                    'height': AppContentInner + 'px'
                })
            }, 300);
            $(window).resize(function() {
            ...
            $(document).on('click', '.wp-chatbot-cart-link', function(event) {
                ...
                var data = {
                    'action': 'qcld_wb_chatbot_cart_page'
                };
                jQuery.post(wpChatBotVar.ajax_url, data, function(response) {
